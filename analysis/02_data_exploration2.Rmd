...
measle$vweek <- week(measle$vacdate)

mea <- measle[, .N, by = .(vyear, vmonth)]
mea2 <- measle[, .N, by = .(vyear, vmonth, vweek)]
mea_delay <- measle[, .N, by = .(vyear, vmonth, vdelay, vacname2)]

measle$byear <- year(measle$dob)
measle$bmonth <- month(measle$dob)
measle$vsyear = year(measle$vsche)
measle$vsmonth = month(measle$vsche)
```
...
ggplot(data = measle[vyear >= 2017 & vyear <= 2020], aes(x = factor(vmonth), y = vdelay, color = factor(vyear))) +
  geom_point() +
...
```{r}
ggplot(data = measle[vyear >= 2017 & vyear <= 2020], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
...
```{r}
ggplot(data = measle[vyear >= 2017 & vyear <= 2020 & vdelay>=0], aes(x = vdelay, y = factor(vsmonth), color = factor(vsyear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
...
```{r}
ggplot(data = measle[byear>= 2017 & byear <= 2020], aes(x = vdelay, y = factor(bmonth), color = factor(byear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
...
```{r}
ggplot(data = diptheria[vyear >= 2017 & vyear <= 2020], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  facet_grid(vacname2~ vyear, scale = "free_y") +
...
```{r, eval=FALSE, echo=FALSE}
ggplot(data = diptheria[vyear >= 2017 & vyear <= 2020], aes(vdelay, color = factor(vyear))) +
  geom_histogram(aes(y = ..density..), binwidth = 1) +
  geom_density() +
  facet_grid(vacname2~ vyear, scale = "free_y") +
...
```{r}
ggplot(data = tuberculosis[vyear >= 2017 & vyear <= 2020], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  facet_grid(vacname2~ vyear, scale = "free_y") +
...
```{r}
ggplot(data = hepatitisb[vyear >= 2017 & vyear <= 2020], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  facet_grid(vacname2~ vyear, scale = "free_y") +
...
```{r}
ggplot(data = polio[vyear >= 2017 & vyear <= 2020], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  facet_grid(vacname2~ vyear, scale = "free_y") +
