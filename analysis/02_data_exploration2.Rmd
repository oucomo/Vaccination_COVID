...
ggplot(data = measle[vyear >= 2017 & vyear <= 2020 & vdelay>=0], aes(x = factor(vmonth), y = vdelay, color = factor(vyear))) +
  geom_point() +
...
```{r}
ggplot(data = measle[vyear >= 2017 & vyear <= 2020 & vdelay>=0], aes(x = vdelay, y = factor(vmonth), color = factor(vyear))) +
  geom_density_ridges() +
  theme_ridges() + 
