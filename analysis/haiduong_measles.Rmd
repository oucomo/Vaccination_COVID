...
# Children born in 2019 received Measles
```{r}
yr <- 2019
...
# Children born in 2019 received Measles or MR
```{r}
yr <- 2019
...
# Children born in 2019 received Measles or MR or MMR
```{r}
yr <- 2019
...
# Children born in 2020 received Measles
```{r}
yr <- 2020
start_yr <- ym(paste0(yr, "-01"))
end_yr <- ym(paste0(yr, "-12"))
...
# Children born in 2020 received Measles or MR
```{r}
yr <- 2020
start_yr <- ym(paste0(yr, "-01"))
end_yr <- ym(paste0(yr, "-12"))
...
# Children born in 2020 received Measles or MR or MMR
```{r}
yr <- 2020
start_yr <- ym(paste0(yr, "-01"))
end_yr <- ym(paste0(yr, "-12"))
