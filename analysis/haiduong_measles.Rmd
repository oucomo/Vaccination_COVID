...
vaccov <- function(kids, measle_all, vcnames, schedule, months_follow, yrs, step_back = 1) {
...
vaccov_2shots <- function(kids, measle_all, vcnames, schedule, months_follow, yrs, step_back = 1) {
...
```{r}
df_cov <- vaccov(kids = kids, measle_all = measle_all,
                 vcnames = c("Measles"), 
                 schedule = 9, 
                 months_follow = 13,
...
```{r}
df_cov <- vaccov_2shots(kids = kids, measle_all = measle_all,
                        vcnames = c("Measles", "MR"), 
                        schedule = 18, 
                        months_follow = 16,
                        yrs = c(2017, 2018, 2019, 2020))
