...
colnames(individual_private_south_overall2) <- c("yeargr", "month", "N")
```

```{r}
ggplot(data = individual_private_south_overall2, aes(x = factor(month), y = N/1000, color = factor(yeargr))) +
...
```{r}
ggplot(individual_private_south_overall2, aes(month, N/1000, color = factor(yeargr))) +
  geom_point(size=2) +
