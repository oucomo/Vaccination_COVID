...
child_private_overall <- child_private[, .N, by = .(year, month)]
child_private_overall2 <- child_private[, .N, by = .(year, month, week)]
child_private_province <- child_private[, .N, by = .(year, month, province)]
child_private_province2 <- child_private[, .N, by = .(year, month, week, province)]
child_private_sex <- child_private[, .N, by = .(year, month, sex)]
child_private_sex2 <- child_private[, .N, by = .(year, month, week, sex)]
child_private_province_sex <- child_private[, .N, by = .(year, month, province, sex)]
child_private_province_sex2 <- child_private[, .N, by = .(year, month, week, province, sex)]
 
save(child_private_overall, child_private_province, child_private_sex, child_private_province_sex, file = file.path("..", "tuann349_vad", "child_private.Rdata"))

tab_child_private_sum <- tbl_summary(child_private[year <= 2020 & year >= 2017, .(province, sex, factor(year))])

save(tab_child_private_sum, file = file.path("..", "tuann349_vad", "tab_child_private.Rdata"))
```
...
vaccine_vad_private$year <- week(vaccine_vad_private$dob)

vaccine_vad_private <- vaccine_vad_private %>% filter(year <= 2020 & year >= 2017)
