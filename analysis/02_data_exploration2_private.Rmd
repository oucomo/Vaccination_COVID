...
tab_individual_private_sum <- tbl_summary(individual_private[year <= 2020, .(province, sex, factor(year))])
...
```{r}
ggplot(data = individual_private_overall[year <= 2020], aes(x = factor(month), y = N/1000, color = factor(year))) +
  geom_rect(aes(xmin = 3, xmax = 5, ymin = -Inf, ymax = Inf), fill = "grey90", color = "grey90", alpha = 0.015) +
  geom_point(size = 3) +
  geom_line(aes(group = year), size = 1.5) +
  scale_x_discrete(name = "Month") +
  scale_y_continuous(name = "Number of individuals born (x 10^3)", breaks = seq(from = 0, to = 150, by = 10)) +
  scale_color_discrete(name = "Year") +
  theme_bw() +
  ggtitle("Total number of individuals born by month and year")
#ggsave(filename = file.path("figures", "individual_private_month_year.png"), width = 7, height = 5)
```

```{r}
ggplot(individual_private_overall[year <= 2020], aes(month, N/1000, color = factor(year))) +
  geom_point(size=3) +
  ...
  ggtitle("Total number of individuals born by month and year")
#ggsave(filename = file.path("figures", "individual_private_month_year3.png"), width = 7, height = 5)
```
