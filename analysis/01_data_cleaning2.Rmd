...
fwrite(x = dups_error, file = file.path(outp, "error_duplicate.csv"))
```
...
fwrite(x = error, file = file.path(outp, "error_datetime.csv"))
```
...
saveRDS(vaccine_clean, file = file.path(outp, "vaccine_clean.rds"))
fwrite(x = vaccine_clean, file = file.path(outp, "vaccine_clean.csv"))
```
